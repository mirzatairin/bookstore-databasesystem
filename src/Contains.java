 ...
 * @author User
 */
public class Contains extends javax.swing.JFrame {

    /**
     * Creates new form Contains
     */
...
String tableName;
    ...
    public Contains(Connection c,String tb) {
        this.connect = c;
        this.tableName = tb;
        initComponents();
    }
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        try{
            ...
            String query = "INSERT INTO "+tableName+" VALUES("+order_no+",'"+book_id+"')";
