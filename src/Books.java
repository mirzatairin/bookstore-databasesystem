...
String tableName;
    ...
    public Books(Connection c,String tb) {
        this.connect = c;
        this.tableName = tb;
        initComponents();
    }
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        String book_name = txtName.getText().toString();
        ...
        try{
            ...
            String query = "INSERT INTO "+tableName+" VALUES("+user_id+",'"+book_name+"','"+language+"','"+country+"','"+price+"')";
