 ...
 * @author User
 */
public class Writes extends javax.swing.JFrame {
...
String tableName;
    ...
    public Writes(Connection c,String tb) {
        this.connect = c;
        this.tableName = tb;
        initComponents();
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(txtWrite, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        String writer_id = txtWrite.getText().toString();
        ...
        try{
            ...
            String query = "INSERT INTO "+tableName+" VALUES("+writer_id+",'"+book_id+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Writes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
