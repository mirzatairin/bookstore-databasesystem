 ...
 * @author User
 */
public class Publishes extends javax.swing.JFrame {

    /**
     * Creates new form Publishes
     */
    Connection connect;
String tableName;
    public Publishes() {
    ...
    public Publishes(Connection c,String tb) {
        this.connect = c;
        this.tableName = tb;
        initComponents();
    }
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(txtPub, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
    ...
    private void btnSubActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubActionPerformed
        ...
        String publisher_id = txtPub.getText().toString();
        ...
        try{
            ...
            String query = "INSERT INTO "+tableName+" VALUES("+publisher_id+",'"+book_id+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Publishes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
